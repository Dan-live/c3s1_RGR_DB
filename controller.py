...
class ControllerBooking:
    ...
    def add_booking_ticket(self):
        ...
        success = self.model_booking_ticket.add_booking_ticket(booking_id, client_id, room_number, booking_start_date, booking_end_date, price)

        # Отображение сообщения о результате операции
        if success:
            self.view_booking_ticket.show_message("Booking added successfully!")
        else:
            self.view_booking_ticket.show_message("Failed to add booking.")
    ...
    def update_booking_ticket(self):
        ...
        if booking_exists:
            ...
            success = self.model_booking_ticket.update_booking_ticket(booking_id, client_id, room_number, booking_start_date,
                                                       booking_end_date, price)

            # Отображение сообщения о результате операции
            if success:
                self.view_booking_ticket.show_message("Booking updated successfully!")
            else:
                self.view_booking_ticket.show_message("Failed to update booking.")
        else:
            self.view_booking_ticket.show_message("Booking with the specified ID does not exist.")
    ...
    def delete_booking_ticket(self):
        ...
        if booking_exists:
            ...
            # Отображение сообщения о результате операции
            if success:
                self.view_booking_ticket.show_message("Booking deleted successfully!")
            else:
                self.view_booking_ticket.show_message("Failed to delete booking.")
        else:
            self.view_booking_ticket.show_message("Booking with the specified ID does not exist.")
class ControllerClient:
    ...
    def update_client(self):
        ...
        client_id, name, surname, email = self.view_client.get_client_input()
        if self.model_client.update_client(client_id, name, surname, email):
...
class ControllerRoom:
    ...
    def update_room(self):
        ...
        if room_exists:
            ...
            # Отображение сообщения о результате операции
            if success:
                self.view_room.show_message("Room updated successfully!")
            else:
                self.view_room.show_message("Failed to update room.")
        else:
            self.view_room.show_message("Room with the specified number does not exist.")
    ...
    def delete_room(self):
        ...
        if room_exists:
            ...
            # Отображение сообщения о результате операции
            if success:
                self.view_room.show_message("Room deleted successfully!")
            else:
                self.view_room.show_message("Failed to delete room.")
        else:
            self.view_room.show_message("Room with the specified number does not exist.")